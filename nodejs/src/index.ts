...
import { createExpressApp } from "./routes/express/index";
import { createFastifyApp } from "./routes/fastify/index";
...
async function main() {
  ...
  expressApp.listen(EXPRESS_PORT, () => {
    console.log(
      `🚀 Express server running on http://localhost:${EXPRESS_PORT}`,
    );
